...
User.create!(name: "An Admin", email: "admin@admin.com", classification: "administrator", password_digest: "$2a$10$l2ZvnTqVQRCjAFqSjyyJhekqXJrAY8HpfMLaJ6h5YBCnLtWPgurIK")
User.create!(name: "Another Admin", email: "admin2@admin.com", classification: "administrator", password_digest: "$2a$10$l2ZvnTqVQRCjAFqSjyyJhekqXJrAY8HpfMLaJ6h5YBCnLtWPgurIK")
...
User.create!(name: "Donor 2", email: "donor2@email.com", classification: "donor", password_digest: "$2a$10$l2ZvnTqVQRCjAFqSjyyJhekqXJrAY8HpfMLaJ6h5YBCnLtWPgurIK")
User.create!(name: "Mr Third Donor", email: "donor3@email.com", classification: "donor", password_digest: "$2a$10$l2ZvnTqVQRCjAFqSjyyJhekqXJrAY8HpfMLaJ6h5YBCnLtWPgurIK")
